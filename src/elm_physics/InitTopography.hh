...
topo_std    [double] gridcell elevation standard deviation -- TOPOGRAPHIC STDdev (STD_ELEV) -- will need to determine
how to calculate these - D4, D8, D2(1d)? Likely scale-dependent. For now I will initialze as 0.0.
