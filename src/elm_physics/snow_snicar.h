...
\param[in]flg_slr_in                          [int] flag: ==1 for direct-beam incident flux, ==2 for diffuse incident
flux \param[in]coszen                              [double] solar zenith angle factor \param[in]h2osno [double] snow
water (mm H2O) \param[in]snl                                 [int] number of snow layers
...
\param[out]flx_abs_lcl[nlevsno+1][numrad_snw] [double] absorbed flux per unit incident flux at top of snowpack (lyr,bnd)
[frc] \param[out]flx_abs[nlevsno+1][numrad]         [double] absorbed flux in each layer per unit flux incident [frc]
...
\param[in]urbpoi                                                         [bool] true if urban point, false otherwise
\param[in]flg_slr_in                                                     [int] flag: ==1 for direct-beam incident flux,
==2 for diffuse incident flux \param[in]snl_top                                                        [int] top snow
layer index [idx] \param[in]snl_btm                                                        [int] bottom snow layer index
[idx] \param[in]coszen                                                         [double] solar zenith angle factor
...
\param[in]ss_alb_oc1[numrad_snw]                                         [double] Mie single scatter albedos for
hydrophillic OC [frc] \param[in]asm_prm_oc1[numrad_snw]                                        [double] Mie asymmetry
parameters for hydrophillic OC [frc] \param[in]ext_cff_mss_oc1[numrad_snw]                                    [double]
Mie mass extinction coefficients for hydrophillic OC [frc] \param[in]ss_alb_oc2[numrad_snw] [double] Mie single scatter
albedos for hydrophobic OC [frc] \param[in]asm_prm_oc2[numrad_snw]                                        [double] Mie
asymmetry parameters for hydrophobic OC [frc] \param[in]ext_cff_mss_oc2[numrad_snw] [double] Mie mass extinction
coefficients for hydrophobic OC [frc] \param[in]ss_alb_dst1[numrad_snw]                                        [double]
Mie single scatter albedos for dust species 1 [frc] \param[in]asm_prm_dst1[numrad_snw] [double] Mie asymmetry parameters
for dust species 1 [frc] \param[in]ext_cff_mss_dst1[numrad_snw]                                   [double] Mie mass
extinction coefficients for dust species 1 [frc] \param[in]ss_alb_dst2[numrad_snw] [double] Mie single scatter albedos
for dust species 2 [frc] \param[in]asm_prm_dst2[numrad_snw]                                       [double] Mie asymmetry
parameters for dust species 2 [frc] \param[in]ext_cff_mss_dst2[numrad_snw]                                   [double]
Mie mass extinction coefficients for dust species 2 [frc] \param[in]ss_alb_dst3[numrad_snw] [double] Mie single scatter
albedos for dust species 3 [frc] \param[in]asm_prm_dst3[numrad_snw]                                       [double] Mie
asymmetry parameters for dust species 3 [frc] \param[in]ext_cff_mss_dst3[numrad_snw] [double] Mie mass extinction
coefficients for dust species 3 [frc] \param[in]ss_alb_dst4[numrad_snw]                                        [double]
Mie single scatter albedos for dust species 4 [frc] \param[in]asm_prm_dst4[numrad_snw] [double] Mie asymmetry parameters
for dust species 4 [frc] \param[in]ext_cff_mss_dst4[numrad_snw]                                   [double] Mie mass
extinction coefficients for dust species 4 [frc \param[in]ss_alb_snw_drc[numrad_snw][idx_Mie_snw_mx] [double] Mie single
scatter albedos for direct-beam ice [frc] \param[in]asm_prm_snw_drc[numrad_snw][idx_Mie_snw_mx] [double] Mie asymmetry
parameters for direct-beam ice [frc] \param[in]ext_cff_mss_snw_drc[numrad_snw][idx_Mie_snw_mx]                [double]
Mie mass extinction coefficients for direct-beam ice [frc] \param[in]ss_alb_snw_dfs[numrad_snw][idx_Mie_snw_mx] [double]
Mie single scatter albedos for diffuse ice [frc] \param[in]asm_prm_snw_dfs[numrad_snw][idx_Mie_snw_mx] [double] Mie
asymmetry parameters for diffuse ice [frc] \param[in]ext_cff_mss_snw_dfs[numrad_snw][idx_Mie_snw_mx] [double] Mie mass
extinction coefficients for diffuse ice [frc] \param[in]ss_alb_bc1[idx_bc_nclrds_max+1][numrad_snw] [double] Mie single
scatter albedos for within-ice BC [frc] \param[in]asm_prm_bc1[idx_bc_nclrds_max+1][numrad_snw] [double] Mie asymmetry
parameters for within-ice BC [frc] \param[in]ext_cff_mss_bc1[idx_bc_nclrds_max+1][numrad_snw]               [double] Mie
mass extinction coefficients for within-ice BC [frc] \param[in]ss_alb_bc2[idx_bc_nclrds_max+1][numrad_snw] [double] Mie
single scatter albedos for external BC [frc] \param[in]asm_prm_bc2[idx_bc_nclrds_max+1][numrad_snw] [double] Mie
asymmetry parameters for external BC [frc] \param[in]ext_cff_mss_bc2[idx_bc_nclrds_max+1][numrad_snw] [double] Mie mass
extinction coefficients for external BC [frc] \param[in]mss_cnc_aer_in[nlevsno][sno_nbr_aer] [double] mass concentration
of all aerosol species [kg/kg] \param[in]bcenh[idx_bcint_icerds_max+1][idx_bc_nclrds_max+1][numrad_snw] [double]
Absorption enhancement factors for within-ice BC

\param[out]g_star[numrad_snw][nlevsno]                                   [double] transformed (i.e. Delta-Eddington)
asymmetry paramater of snow+aerosol layer \param[out]omega_star[numrad_snw][nlevsno] [double] transformed (i.e.
...
\param[in]urbpoi                              [bool] true if urban point, false otherwise
\param[in]flg_slr_in                          [int] flag: ==1 for direct-beam incident flux, ==2 for diffuse incident
flux \param[in]flg_nosnl                           [int] flag: =1 if there is snow, but zero snow layers
...
\param[in]g_star[numrad_snw][nlevsno]         [double] transformed (i.e. Delta-Eddington) asymmetry paramater of
snow+aerosol layer \param[in]omega_star[numrad_snw][nlevsno]     [double] transformed (i.e. Delta-Eddington) SSA of
snow+aerosol layer [frc] \param[in]tau_star[numrad_snw][nlevsno]       [double] transformed (i.e. Delta-Eddington)
...
\param[in]urbpoi                             [bool] true if urban point, false otherwise
\param[in]flg_slr_in                         [int] flag: ==1 for direct-beam incident flux, ==2 for diffuse incident
flux \param[in]snl_top                            [int] top snow layer index [idx] \param[in]coszen [double] solar
zenith angle factor \param[in]mu_not                             [double] cosine solar zenith angle above the fresnel
level \param[in]h2osno                             [double] snow water (mm H2O) \param[in]snw_rds_lcl[nlevsno] [int]
snow effective radius [m^-6] \param[in]albsoi[numrad]                     [double] albedo of surface underlying snow
[frc] \param[in]albout_lcl[numrad_snw]             [double] snow albedo by band [frc]
