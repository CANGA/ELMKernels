...
ELM::SnicarData::SnicarData()
    : ss_alb_oc1("ss_alb_oc1", snow_snicar::numrad_snw), asm_prm_oc1("asm_prm_oc1", snow_snicar::numrad_snw),
      ext_cff_mss_oc1("ext_cff_mss_oc1", snow_snicar::numrad_snw), ss_alb_oc2("ss_alb_oc2", snow_snicar::numrad_snw),
      asm_prm_oc2("asm_prm_oc2", snow_snicar::numrad_snw), ext_cff_mss_oc2("ext_cff_mss_oc2", snow_snicar::numrad_snw),
      ss_alb_dst1("ss_alb_dst1", snow_snicar::numrad_snw), asm_prm_dst1("asm_prm_dst1", snow_snicar::numrad_snw),
      ext_cff_mss_dst1("ext_cff_mss_dst1", snow_snicar::numrad_snw),
      ss_alb_dst2("ss_alb_dst2", snow_snicar::numrad_snw), asm_prm_dst2("asm_prm_dst2", snow_snicar::numrad_snw),
      ext_cff_mss_dst2("ext_cff_mss_dst2", snow_snicar::numrad_snw),
      ss_alb_dst3("ss_alb_dst3", snow_snicar::numrad_snw), asm_prm_dst3("asm_prm_dst3", snow_snicar::numrad_snw),
      ext_cff_mss_dst3("ext_cff_mss_dst3", snow_snicar::numrad_snw),
      ss_alb_dst4("ss_alb_dst4", snow_snicar::numrad_snw), asm_prm_dst4("asm_prm_dst4", snow_snicar::numrad_snw),
