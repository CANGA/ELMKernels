...
ConsititutiveAirProperties<ArrayD1>::ConsititutiveAirProperties(const ArrayD1& forc_qbot, const ArrayD1& forc_pbot, const ArrayD1& forc_tbot, ArrayD1& forc_vp, ArrayD1& forc_rho, ArrayD1& forc_po2, ArrayD1& forc_pco2) 
...
template<typename ArrayD1>
constexpr void ConsititutiveAirProperties<ArrayD1>::operator()(const int i) const {
...
ProcessTBOT<ArrayD1, ArrayD2>::ProcessTBOT(const int& t_idx, const double& wt1, const double& wt2, const ArrayD2& atm_tbot, ArrayD1& forc_tbot, ArrayD1& forc_thbot) 
...
template<typename ArrayD1, typename ArrayD2>
ProcessPBOT<ArrayD1, ArrayD2>::ProcessPBOT(const int& t_idx, const double& wt1, const double& wt2, const ArrayD2& atm_pbot, ArrayD1& forc_pbot) 
...
template<typename ArrayD1, typename ArrayD2>
ProcessFLDS<ArrayD1, ArrayD2>::ProcessFLDS(const int& t_idx, const double& wt1, const double& wt2, const ArrayD2& atm_flds, 
...
template<typename ArrayD1, typename ArrayD2>
  ProcessFSDS<ArrayD1, ArrayD2>::ProcessFSDS(const ArrayD1& atm_fsds, const ArrayD1& coszen, ArrayD2& forc_solai, ArrayD2& forc_solad) 
...
template<typename ArrayD1>
  ProcessPREC<ArrayD1>::ProcessPREC(const ArrayD1& atm_prec, const ArrayD1& forc_tbot, ArrayD1& forc_rain, ArrayD1& forc_snow) 
...
template<typename ArrayD1, typename ArrayD2>
  ProcessWIND<ArrayD1, ArrayD2>::ProcessWIND(const int& t_idx, const double& wt1, const double& wt2, const ArrayD2& atm_wind, 
