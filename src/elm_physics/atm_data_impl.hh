...
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr void AtmDataManager<ArrayD1, ArrayD2, ftype>::update_file_info(const Utils::Date& new_file_start_time,
...
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr double AtmDataManager<ArrayD1, ArrayD2, ftype>::get_forc_dt_days() {
  return forc_dt_;
}

// interface to return forc_dt_ in seconds
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr double AtmDataManager<ArrayD1, ArrayD2, ftype>::get_forc_dt_secs() {
...
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr size_t
AtmDataManager<ArrayD1, ArrayD2, ftype>::forc_t_idx_aligned(const double& delta_to_model_time, const double& model_dt,
...
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr size_t
AtmDataManager<ArrayD1, ArrayD2, ftype>::forc_t_idx_check_bounds(const double& model_dt, const Utils::Date& model_time,
                                                                 const Utils::Date& forc_record_start_time) const {
...
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr size_t AtmDataManager<ArrayD1, ArrayD2, ftype>::forc_t_idx(const Utils::Date& model_time,
                                                                     const Utils::Date& forc_record_start_time) const {
...
AtmDataManager<ArrayD1, ArrayD2, ftype>::forcing_time_weights(const size_t t_idx, const Utils::Date& model_time) const {
...
constexpr auto&
AtmDataManager<ArrayD1, ArrayD2, ftype>::get_ref_to_dim(const std::string& dimname, const Comm_type& comm,
...
template <typename ArrayD1, typename ArrayD2, AtmForcType ftype>
constexpr void AtmDataManager<ArrayD1, ArrayD2, ftype>::read_atm_forcing(const Utils::DomainDecomposition<2>& dd,
                                                                         const Utils::Date& model_time,
                                                                         const size_t ntimes) {
...
constexpr void AtmDataManager<ArrayD1, ArrayD2, ftype>::get_atm_forcing(const double& model_dt,
                                                                        const Utils::Date& model_time, Args&&...args) {
  ...
  const auto physics_object = [this, t_idx, &wt1, &wt2, &args...] {
    if constexpr (ftype == AtmForcType::TBOT) {
      ...
      return atm_forcing_physics::ProcessQBOT<ArrayD1, ArrayD2, ftype>(t_idx, wt1, wt2, data_,
