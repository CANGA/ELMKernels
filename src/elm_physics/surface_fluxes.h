...
void update_surface_fluxes(const bool& urbpoi, const bool& do_capsnow, const int& snl, const double& dtime,
                           ...
                           double& qflx_ev_h2osfc, double& eflx_soil_grnd, double& eflx_sh_tot, double& qflx_evap_tot,
                           double& eflx_lh_tot, double& qflx_evap_grnd, double& qflx_sub_snow, double& qflx_dew_snow,
                           double& qflx_dew_grnd, double& qflx_snwcp_liq, double& qflx_snwcp_ice);
...
void lwrad_outgoing(const bool& urbpoi, const int& snl, const int& frac_veg_nosno, const double& forc_lwrad,
                    ...
                    const double& emg, double& eflx_lwrad_out, double& eflx_lwrad_net);
