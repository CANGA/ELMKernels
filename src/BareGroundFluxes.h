...
public:
  ...
  */
  void InitializeFlux(const LandType &Land, const int &frac_veg_nosno_in, const double &forc_u, const double &forc_v,
                      const double &forc_q_in, const double &forc_th_in, const double &forc_hgt_u_patch_in,
                      const double &thm_in, const double &thv_in, const double &t_grnd, const double &qg,
                      const double &z0mg_in, double &dlrad, double &ulrad);
  ...
  */
  void StabilityIteration(const LandType &Land, const double &forc_hgt_t_patch, const double &forc_hgt_q_patch,
                          const double &z0mg, const double &zii, const double &beta, double &z0hg, double &z0qg);
  ...
  */
  ...
  void ComputeFlux(const LandType &Land, const int &snl, const double &forc_rho, const double &soilbeta,
                   const double &dqgdT, const double &htvp, const double &t_h2osfc, const double &qg_snow,
                   const double &qg_soil, const double &qg_h2osfc, const dArray_type t_soisno, const double &forc_pbot,
                   double &cgrnds, double &cgrndl, double &cgrnd, double &eflx_sh_grnd, double &eflx_sh_tot,
                   double &eflx_sh_snow, double &eflx_sh_soil, double &eflx_sh_h2osfc, double &qflx_evap_soi,
                   double &qflx_evap_tot, double &qflx_ev_snow, double &qflx_ev_soil, double &qflx_ev_h2osfc,
