...
soil, i = snl+1 is top layer. Here we use a positive snl - i=0 is layer next to soil, and i=snl-1 is top layer.
...
void ColdStartSnow(const double &snow_depth, const bool &lakpoi,

                   int &snl, double *dz, double *z, double *zi) {
