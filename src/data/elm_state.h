...
// convenience struct
// primary variables that need to be saved in case of convergence issues
...
template<typename ArrayB1, typename ArrayI1, typename ArrayI2,
         typename ArrayD1, typename ArrayD2, typename ArrayD3,
         typename ArrayPSN1>
struct ELMState : public ELMStateViews<ArrayB1, ArrayI1, ArrayI2, ArrayD1, ArrayD2, ArrayD3, ArrayPSN1> {
  ...
  // aerosol masses and concentrations
  // FileInput doesn't need to be persistent and should be moved
...
template<typename ArrayB1, typename ArrayI1, typename ArrayI2,
         typename ArrayD1, typename ArrayD2, typename ArrayD3,
         typename ArrayPSN1>
struct ELMState_ATS : public ELMStateViews<ArrayB1, ArrayI1, ArrayI2, ArrayD1, ArrayD2, ArrayD3, ArrayPSN1> {

  ELMState_ATS(int ncols,
          const Utils::DomainDecomposition<2>& domain,
          const std::string& filename,
          const ELM::Utils::Date &file_start_time,
          int forc_steps);
  ...
  // time-variable - initialize outside of constructor
  std::shared_ptr<ELM::phen_data::PhenologyFileInput<ArrayD1>> phen_data;
  std::shared_ptr<ELM::atm_data::AtmosphereFileInput<ArrayD1>> atm_forcing;
};
