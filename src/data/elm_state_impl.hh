...
template<typename ArrayB1, typename ArrayI1, typename ArrayI2,
         ...
         typename ArrayPSN1>
ELMStateViews<ArrayB1, ArrayI1, ArrayI2, ArrayD1, ArrayD2, ArrayD3, ArrayPSN1>::
...
ELMState(int ncols,
    ...
    // base constructor
    ELMStateViews<ArrayB1, ArrayI1, ArrayI2, ArrayD1, ArrayD2, ArrayD3, ArrayPSN1>(ncols),
...
template<typename ArrayB1, typename ArrayI1, typename ArrayI2,
         typename ArrayD1, typename ArrayD2, typename ArrayD3,
         typename ArrayPSN1>
ELMState_ATS<ArrayB1, ArrayI1, ArrayI2, ArrayD1, ArrayD2, ArrayD3, ArrayPSN1>::
...
:
  ...
  aero_concen(std::make_shared<ELM::aero_data::AerosolConcentrations<ArrayD2>>(ncols)),
  // container for satellite phenology forcing data
  phen_data(std::make_shared<ELM::phen_data::PhenologyFileInput<ArrayD1>>(ncols)),
  // container for atmospheric forcing data
  atm_forcing(std::make_shared<ELM::atm_data::AtmosphereFileInput<ArrayD1>>(ncols))
{}
