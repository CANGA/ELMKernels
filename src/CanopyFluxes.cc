...
qg                           ouble] ground specific humidity [kg/kg]
...
void InitializeFlux_Can(const LandType &Land, const int &snl, const int &frac_veg_nosno, const double &frac_sno,
                        ...
                        const double h2osoi_liq[nlevgrnd + nlevsno], const double dz[nlevgrnd + nlevsno],
                        const double rootfr[nlevgrnd], const double &tc_stress, const double *sucsat,
                        const double *watsat, const double *bsw, const double *smpso, const double *smpsc,
                        const double &elai, const double &esai, const double &emv, const double &emg, const double &qg,
                        const double &t_grnd, const double &forc_t, const double &forc_pbot, const double &forc_lwrad,
                        const double &forc_u, const double &forc_v, const double &forc_q, const double &forc_th,
                        const double &z0mg,
                        ...
                        double &dayl_factor, double &air, double &bir, double &cir, double &el, double &qsatl,
                        double &qsatldT, double &taf, double &qaf, double &um, double &ur, double &obu, double &zldis,
                        double &delq, double &t_veg
...
*/
void StabilityIteration_Can(
    const LandType &Land, const double &dtime, const int &snl, const int &frac_veg_nosno, const double &frac_sno,
    const double &forc_hgt_u_patch, const double &forc_hgt_t_patch, const double &forc_hgt_q_patch, const double *dleaf,
    const double &fwet, const double &fdry, const double &laisun, const double &laisha, const double &forc_rho,
    const double &snow_depth, const double &soilbeta, const double &frac_h2osfc, const double &t_h2osfc,
    const double &sabv, const double &h2ocan, const double &htop, const double t_soisno[nlevgrnd + nlevsno],
    const double &air, const double &bir, const double &cir, const double &ur, const double &zldis,
    const double &displa, const double &elai, const double &esai, const double &t_grnd, const double &forc_pbot,
    const double &forc_q, const double &forc_th, const double &z0mg, const double &z0mv, const double &z0hv,
    ...
    const double &forc_pco2, const double &forc_po2, const double &dayl_factor,

    double &btran, double &qflx_tran_veg, double &qflx_evap_veg, double &eflx_sh_veg, double &wtg, double &wtl0,
    double &wta0, double &wtal, double &el, double &qsatl, double &qsatldT, double &taf, double &qaf, double &um,
    double &dth, double &dqh, double &obu, double &temp1, double &temp2, double &temp12m, double &temp22m,
    double &tlbef, double &delq, double &dt_veg, double &t_veg, double &wtgq, double &wtalq, double &wtlq0,
    double &wtaq0)
...
*/
void ComputeFlux_Can(
    const LandType &Land, const double &dtime, const int &snl, const int &frac_veg_nosno, const double &frac_sno,
    const double t_soisno[nlevgrnd + nlevsno], const double &frac_h2osfc, const double &t_h2osfc, const double &sabv,
    const double &qg_snow, const double &qg_soil, const double &qg_h2osfc, const double &dqgdT, const double &htvp,
    const double &wtg, const double &wtl0, const double &wta0, const double &wtal, const double &air, const double &bir,
    const double &cir, const double &qsatl, const double &qsatldT, const double &dth, const double &dqh,
    const double &temp1, const double &temp2, const double &temp12m, const double &temp22m, const double &tlbef,
    const double &delq, const double &dt_veg, const double &t_veg, const double &t_grnd, const double &forc_pbot,
    const double &qflx_tran_veg, const double &qflx_evap_veg, const double &eflx_sh_veg, const double &forc_q,
    const double &forc_rho, const double &thm, const double &emv, const double &emg, const double &forc_lwrad,
    const double &wtgq, const double &wtalq, const double &wtlq0, const double &wtaq0,

    double &h2ocan, double &eflx_sh_grnd, double &eflx_sh_snow, double &eflx_sh_soil, double &eflx_sh_h2osfc,

    double &qflx_evap_soi, double &qflx_ev_snow, double &qflx_ev_soil, double &qflx_ev_h2osfc,

    double &dlrad, double &ulrad, double &cgrnds, double &cgrndl, double &cgrnd, double &t_ref2m, double &t_ref2m_r,
    double &q_ref2m, double &rh_ref2m, double &rh_ref2m_r) {
