...
public:
  ...
  */
  void SaveGroundTemp(const LandType &Land, const double &t_h2osfc, const double *t_soisno, double &t_h2osfc_bef,
                      double *tssbef) {
  ...
  */
  void CalculateGroundTemp(const LandType &Land, const int &snl, const double &frac_sno_eff, const double &frac_h2osfc,
                           const double &t_h2osfc, const double *t_soisno, double &t_grnd) {
  ...
  */
  ...
  void CalculateSoilAlpha(const LandType &Land, const int &nlevbed, const int &nlevsoi, const double &frac_sno,
                          const double &frac_h2osfc, const double &smpmin, const double *h2osoi_liq,
                          const double *h2osoi_ice, const double *dz, const double *t_soisno, const double *watsat,
                          const double *sucsat, const double *bsw, const double *watdry, const double *watopt,
                          const double *rootfr_road_perv,

                          double *rootr_road_perv, double &qred, double &hr, double &soilalpha, double &soilalpha_u) {
  ...
  */
  void GroundProperties(const LandType &Land, const int &snl, const double &frac_sno, const double &forc_th,
                        ...
                        const double *displar, const double *z0mr, const double *h2osoi_liq, const double *h2osoi_ice,

                        double &emg, double &emv, double &htvp, double &z0mg, double &z0hg, double &z0qg, double &z0mv,
                        double &z0hv, double &z0qv, double &beta, double &zii, double &thv, double &z0m, double &displa,
                        double &cgrnd, double &cgrnds, double &cgrndl) {
    if (!Land.lakpoi) {
  ...
  */
  void CalculateForcingHeight(const LandType &Land, const bool &veg_active, const int &frac_veg_nosno,
                              ...
                              const double &forc_t, const double &displa,

                              double &forc_hgt_u_patch, double &forc_hgt_t_patch, double &forc_hgt_q_patch,
                              double &thm) {
