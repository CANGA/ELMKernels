#ifndef ELM_CANOPY_HYDROLOGY_CUDA_HH_
#define ELM_CANOPY_HYDROLOGY_CUDA_HH_

namespace ELM {

__global__ void CanopyHydrology_Interception(double dtime,
...
__global__ void CanopyHydrology_FracH2OSfc(const double& dtime,
