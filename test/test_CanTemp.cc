...
int main(int argc, char **argv) {
  ...
  for (std::size_t t = 1; t < 49; ++t) {
    ...
    ELM::GroundProperties(Land, snl[idx], frac_sno[idx], forc_th[idx], forc_q[idx], elai[idx], esai[idx], htop[idx],
    ...
    ELM::CalculateForcingHeight(Land, veg_active[idx], frac_veg_nosno[idx], forc_hgt_u[idx], forc_hgt_t[idx], forc_hgt_q[idx],
    ...
    ELM::InitializeEnergyFluxes(Land, eflx_sh_tot[idx], eflx_sh_tot_u[idx], eflx_sh_tot_r[idx], eflx_lh_tot[idx],
