...
//
// This example plays with geometric regions in FlecCSI by figuring out one way
...
flecsi_register_task(top_level_task, ELM, loc, index);
...
void driver(int argc, char ** argv)
{
  ...
  flecsi_execute_task(top_level_task, ELM, single);
